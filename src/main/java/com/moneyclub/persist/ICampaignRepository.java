...
public interface ICampaignRepository {
    ...
    List<CampaignReport> generateCampaignReportSummary(final long campaignId, final String campaignDate) throws PersistentException;
    ...
    List<CampaignEntity>  findCampaignDetailsById(final Long id) throws PersistentException;
    int updateStatus(final long id, final int status, final String comments) throws PersistentException;
    int createCampaign(final Campaign campaign) throws PersistentException;
